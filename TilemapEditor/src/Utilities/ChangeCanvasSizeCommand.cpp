...
ChangeCanvasSizeCommand::ChangeCanvasSizeCommand( std::shared_ptr<class Canvas>& canvas, const int& prevCanvasWidth,
...
{
	// Nothing to set
	// LOG_INFO("width: {0}\nprevWidth: {1}\nheight: {2}\nprevHeight: {3}", mCanvasWidth, mPrevCanvasWidth,
	// mCanvasHeight, mPrevCanvasHeight);
}
